      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute -inset-0.5 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl blur opacity-10 group-hover:opacity-30 transition duration-300" />
              <div className="relative bg-white rounded-2xl p-8 ring-1 ring-gray-100 border border-gray-100">
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
                  {feature.icon}
                </div>
